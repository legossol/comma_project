...
public class RefUtil {
    ...
    public static Consumer<String> pr = System.out::println;
    public static Function<Object, String> valOv = String::valueOf;
    public static BiPredicate<String,String> equ = String::equals;
    ...
    // public static Function<Integer, String> int2str = Integer::parseInt;
